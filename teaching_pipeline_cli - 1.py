...
def run_teaching_pipeline(task: str,
    ...
    # ------ 写入记忆：兼容不同 GraphMemory 实现，避免再报 AttributeError ------
    memory_item = {
        "task": task,
